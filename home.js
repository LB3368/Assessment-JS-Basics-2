...
function canWeDeliver(zipCode) {
    const deliveryZones = [30260, 85205, 30808, 85201, 30294]
...
const canWeDeliverTwo = (zipCode) => {
    const deliveryAreaZipCodes = [90210, 65432, 12345, 33698, 45879]
    for (let i = 0; i < deliveryAreaZipCodes.length; i++) {
        if (deliveryAreaZipCodes[i] === zipCode) {
            console.log(`You are elible for delivery!`)
            return
        }
    }
    console.log(`Sorry, we don't deliver to your area.`)
}
canWeDeliverTwo(90210)
canWeDeliverTwo(30260)
...
//CODE HERE
deals[1].desc = deals[1].desc.replace(/\s+/g, ' ').replace('March', 'April')
